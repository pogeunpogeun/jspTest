...
<%
    	...
    	if(passwd == null || passwd.equals("")) {
    		out.println("비밀번호가 입력안됨");
    		return;
    	}
  
    	if(phone == null || phone.equals("")) {
    		out.println("연락처가 입력안됨");
    		return;
    	}
    	if(email == null || email.equals("")) {
    		out.println("이메일이 입력안됨");
    		return;
    	}
    	if(address == null || address.equals("")) {
    		out.println("주소가 입력안됨");
    		return;
    	}
 ...
 ;   		//--------------------------------------------------
    	...
    	if(result > 0) {
    	      ...
    	      out.print("location.href='main.jsp?menuGubun=member2_sujung&arg1" + arg1 + "';");
    	      out.print("</script>");
    	   }
